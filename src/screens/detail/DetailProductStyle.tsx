...
type UpdateProductStyleProps = {
    onSubmit: (id: string, values: any) => void;
    onCancel: () => void;
    style: any;
};
const DetailProductStyle = ({ onSubmit, onCancel, style }: UpdateProductStyleProps) => {
    ...
    useEffect(() => {
        ...
        setValue('title', style.title);
        setValue('subTitle', style.subTitle);
    }, []);
    return (
        <>
            <div>
                        ...
                        <div className='flex flex-col gap-4'>
                            <WrapperField>
                                <label htmlFor='' className='font-bold flex text-left'>
                                    Style Name<p className='text-red-700 ml-1'>*</p>:
                                </label>
                                <InputDefault
